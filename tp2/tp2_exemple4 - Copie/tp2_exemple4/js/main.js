...
function createGuys( scene )
{
	...
	BABYLON.SceneLoader.ImportMesh( "", "models/", "guy.babylon", scene, ( newMeshes, particleSystems, skeletons ) =>
	{
		...
		for ( let i = 0; i < 3; i++ )
		{
			...
			scene.beginAnimation( scene.guys[ i ].skeleton, 0, 120, true, 1 );
...
{
	// BABYLON.SceneLoader.ImportMesh("", "models/Tank/", "Tank.babylon", scene, function(newMeshes)
	// {
	...
	tankMaterial.diffuseTexture = new BABYLON.Texture( "images/grass.png" );
